...
- `bronnen/yoursportplanner-handbal.json` — 500 handbaloefeningen: 50 gecureerd (mét trainer_labels/why_match) + 450 uit de detail-page-export (`yoursportplanner_handbal_poc_500_metadata.json`, hoogwaardig: echte description/levels/techniques). **gitignored, server-side.** Herbouwen: `node scripts/build-ysp-extra.mjs`.
